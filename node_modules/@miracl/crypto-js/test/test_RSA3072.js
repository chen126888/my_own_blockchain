...
import VECTORS_RSA3072 from '../testVectors/rsa/RSA3072.js';
...
describe('TEST RSA RSA3072', function() {
    ...
    it('test RSA Enctyption/Decryption', function(done) {
        ...
        for (var vector in VECTORS_RSA3072) {

            ctx.FF.fromBytes(priv.p, Buffer.from(VECTORS_RSA3072[vector].PrivP, "hex"));
            ctx.FF.fromBytes(priv.q, Buffer.from(VECTORS_RSA3072[vector].PrivQ, "hex"));
            ctx.FF.fromBytes(priv.dp, Buffer.from(VECTORS_RSA3072[vector].PrivDP, "hex"));
            ctx.FF.fromBytes(priv.dq, Buffer.from(VECTORS_RSA3072[vector].PrivDQ, "hex"));
            ctx.FF.fromBytes(priv.c, Buffer.from(VECTORS_RSA3072[vector].PrivC, "hex"));
            ctx.FF.fromBytes(pub.n, Buffer.from(VECTORS_RSA3072[vector].PubN, "hex"));
            pub.e = VECTORS_RSA3072[vector].PubE;
